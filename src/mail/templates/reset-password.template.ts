export const getResetPasswordMessage = (
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text">
                                                                                        <p>Hello.</p>
                                                                                        <p><br></p>
                                                                                        <p>You can reset your TrackDigits password by clicking the link below or copying and pasting it into your browser. For increased security, this password reset link will expire 5 minutes after it was sent.<br><br></p>
...
\t</v:roundrect></a>
<![endif]-->
                                                                                        <!--[if !mso]><!-- --><span class="msohide es-button-border-1667977983101 es-button-border" style="border-radius: 8px; border-width: 0px; background: #009af7; border-color: #2cb543;"><a href="${resetPasswordLink}" class="es-button es-button-1667977917975" target="_blank" style="border-width: 10px 50px;border-radius: 8px;font-family: tahoma, verdana, segoe, sans-serif;background: #009af7;border-color: #009af7;padding: 10px;color: #fff;text-decoration: none;">Reset Your Password</a></span>
                                                                                        <!--<![endif]-->
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10b">
                                                                                        <p style="font-size: 12px;"><b>Too late?</b> You can request another password reset <a href="${resetUrl}" target="_blank"></a> here.</p>
                                                                                        <p style="font-size: 12px;"><b>Didn’t request this email?</b> You don't need to do anything. Your password will stay the same.</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-button es-p10t">
                                                                                        <!--[if mso]><a href="mailto:admin@trackdigits.com" target="_blank" hidden>
\t<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="mailto:admin@trackdigits.com" 
                style="height:24px; v-text-anchor:middle; width:176px" arcsize="50%" stroke="f"  fillcolor="#ffffff">
\t\t<w:anchorlock></w:anchorlock>
\t\t<center style='color:#1d2024; font-family:tahoma, verdana, segoe, sans-serif; font-size:8px; font-weight:400; line-height:8px;  mso-text-raise:1px'>admin@trackdigits.com</center>
\t</v:roundrect></a>
<![endif]-->
                                                                                        <!--[if !mso]><!-- --><span class="msohide es-button-border-1667980167657 es-button-border" style="border-width: 0px; background: #ffffff; border-color: #2cb543;"><a href="mailto:admin@trackdigits.com" class="es-button es-button-1667980167657" target="_blank" style="font-family: tahoma, verdana, segoe, sans-serif; border-width: 0px; background: #ffffff; border-color: #ffffff; font-size: 14px; font-weight: normal; color: #1d2024;">admin@trackdigits.com</a></span>
                                                                                        <!--<![endif]-->
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
